 ...
 * -----------------------------------------------------------------------------
 *
 *   This project is a simple tool that simulates CMOS circuits in JavaScript.
 *   You can visualize and check every logic circuit that you can imagine.
 *   
 *   
 *   Contact to author:
 *       Robert Rypuła
...
function SimpleCmosClass()
{
    ...
    this.api = {
        ...
        /* methods */
        newProject : function(sizeX, sizeY, sizePix, levelCount) { return this.api; },
        loadProject : function(project) { return this.api; },
        saveProject : function() { },
        getAvaiablePredefinedObjectList : function() { },
        insertPredefinedObjectInClipboard : function(name) { return this.api; },
        setToolDivConfig : function(toolDiv, rendererCallback) { return this.api; },
        setLevelDivConfig : function(levelDiv, rendererCallback) { return this.api; },
        selectedBoxSelectAll : function() { return this.api; },
        selectedBoxCopy : function() { return this.api; },
        selectedBoxClear : function() { return this.api; },
        selectedBoxCut : function() { return this.api; },
        selectedBoxFillByWire : function() { return this.api; },
        selectedBoxSetPressure : function() { return this.api; },
        selectedBoxSetResistance : function() { return this.api; },
        selectedBoxDeselect : function() { return this.api; },
        
        /* events */
        onProjectDimensionChange : function(callback) { return this.api; },
        onSimulationStatusChange : function(callback) { return this.api; },
        onStabilize : function(callback) { return this.api; },

        /* options setters */
        setTool : function(tool) { return this.api; },
        setLevel : function(lv) { return this.api; },
        setPower : function(powerActive) { return this.api; },
        setSimulation : function(simulationActive) { return this.api; },
        setLoopInOneFrame : function(loopsCount) { return this.api; },
        setDesiredFps : function(fps) { return this.api; },
        setLevelTransparency : function(transparentActive) { return this.api; },
        setResistance : function(resistance) { return this.api; },
        setPressure : function(pressure) { return this.api; },
        ...
        getLoopInOneFrame : function() { },
        getDesiredFps : function() { },
        getLevelTransparency : function() { },
    ...
    {
        if (jQObj.canvas !== null) {
            throw 'SimpleCmos error: Already inited';
            return;
        }
        jQObj.canvas  = canvasObj;
    }
...
(function ($) {
    $.fn.SimpleCmos = function(mode) {
        var simpleCmos;
        
        if (typeof mode === 'string' && mode == "api") {
            if (this.size()==1) {
                simpleCmos = this.data('SimpleCmos');
                if (simpleCmos)
                    return simpleCmos.api; else 
                    throw 'SimpleCmos error: There is no API. Try to call $(_selector_).SimpleCmos() first';
            } else {
                throw 'SimpleCmos error: API can be fetched only for one jQuery object. Selector points to ' + this.size() + ' elements.';
            }
        }
        ...
        return this.each(function() {
            ...
            if (!simpleCmos) {
                simpleCmos = new SimpleCmosClass();
                simpleCmos.init($(this));
                $(this).data('SimpleCmos', simpleCmos);
            }
        });
    };
})(jQuery);
